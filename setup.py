...
setup(
  name = 'free_invoice_generator',         #* Your package will have this name
  ...
  author = 'Abbas bukhari',                   # Your name
  author_email = 'shahabbas661@gmail.com',  # Your email
  url = 'https://github.com/MAB-100/App20',              # Homepage of your library (e.g. github or your website)
